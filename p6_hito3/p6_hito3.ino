...
/* Includes ---------------------------------------------------------------- */
#include <daniel-zl-master-RSE-FINAL_inferencing.h>
...
void loop() {
  ...
  if (best_value >= CONFIDENCE_THRESHOLD) {
    ei_printf(">>> Clase detectada: %s (%.5f)\r\n", best_label, best_value);
    if (best_label == "idle") {
      digitalWrite(LED_R, 1);
      digitalWrite(LED_G, 1);
      digitalWrite(LED_B, 1);
    } else if (best_label == "pitch_pos") {
      digitalWrite(LED_R, 1);
      digitalWrite(LED_G, 0);
      digitalWrite(LED_B, 1);
    } else if (best_label == "pitch_negative") {
      digitalWrite(LED_R, 0);
      digitalWrite(LED_G, 0);
      digitalWrite(LED_B, 1);
    } else if (best_label == "roll_positive") {
      digitalWrite(LED_R, 0);
      digitalWrite(LED_G, 1);
      digitalWrite(LED_B, 1);
    } else if (best_label =="roll_negative") {
      digitalWrite(LED_R, 0);
      digitalWrite(LED_G, 1);
      digitalWrite(LED_B, 0);
    } else if (best_label == "yaw_positive") {
      digitalWrite(LED_R, 1);
      digitalWrite(LED_G, 1);
      digitalWrite(LED_B, 0);
    } else if (best_label == "yaw_negative") {
      digitalWrite(LED_R, 0);
      digitalWrite(LED_G, 1);
      digitalWrite(LED_B, 0);
    } else {
      ei_printf(">>> Resultado incierto (max: %.5f)\r\n", best_value);
    }
